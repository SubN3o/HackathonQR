...
use WCS\QdlmqtBundle\Entity\Categorie;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('WCSQdlmqtBundle:Categorie')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('WCS\QdlmqtBundle\Form\CategorieType', $categorie);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('WCS\QdlmqtBundle\Form\CategorieType', $categorie);
